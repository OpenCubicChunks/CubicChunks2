...
public class MixinPortalForcer {
    ...
    @Redirect(method = "method_30479" /*"lambda$findPortalAround$5(Lnet/minecraft/world/entity/ai/village/poi/PoiRecord;)Lnet/minecraft/BlockUtil$FoundRectangle;"*/, at = @At(value =
        "INVOKE",
