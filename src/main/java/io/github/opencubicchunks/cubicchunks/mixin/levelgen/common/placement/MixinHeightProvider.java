...
public abstract class MixinHeightProvider implements CubicHeightProvider {
    ...
    @Shadow public abstract int sample(RandomSource random, WorldGenerationContext context);

    @Override public OptionalInt sampleCubic(RandomSource random, WorldGenerationContext context, int minY, int maxY) {
